...
# Instructions
# À l’aide de cette API, créez la fonctionnalité qui écrira 10 pays aléatoires 
# dans votre basede données.

# Ce sont les attributs avec lesquels vous devez remplir vos tableaux: nom, capitale
# , drapeau, sous-région, population.
